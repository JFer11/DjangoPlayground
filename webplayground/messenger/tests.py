...
"""
python manage.py test messenger -> To run all tests for an application.
python manage.py test messenger.tests.ThreadTestCase -> To run all tests from a class for an application.
python manage.py test messenger.tests.ThreadTestCase -> To run a test from a class for an application.
"""
