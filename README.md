...
3. Manipulation of django Forms, ModelForms, extra validations and custom widgets.
4. Mixin views and views inheritance.
5. User authentication.
6. Management of different user permissions.
7. Customizing Django's authentication system with custom SignUp and SignIn views.
8. Password recovery system with email.
9. Send emails.
10. Deep use of multiple template tags.
11. Template inheritance.
12. Custom queries overriding the model manager.
13. Add additional context to the processor context.
14. Testing.
...
Note: Backend language: English. Frontend language: Spanish.
